 INSTALL_DIR=$(pwd)
 wget -O $INSTALL_DIR/openvscode-server.tar.gz https://github.com/gitpod-io/openvscode-server/releases/download/openvscode-server-v1.74.0/openvscode-server-v1.74.0-linux-x64.tar.gz
