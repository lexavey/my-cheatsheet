...
mv git-*/ git
cd git
NO_EXPAT=yes NO_OPENSSL=yes NO_CURL=yes make configure
...
NO_EXPAT=yes NO_OPENSSL=yes NO_CURL=yes make NO_GETTEXT=Nope NO_TCLTK=Nope 
NO_EXPAT=yes NO_OPENSSL=yes NO_CURL=yes make install NO_GETTEXT=Nope NO_TCLTK=Nope
